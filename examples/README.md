...
| [`ordered_parallel.rs`](ordered_parallel.rs) | Preserving input record order in the output, opt-in per processor via `parallel::Ordered` or a direct `requires_ordering` override. |
